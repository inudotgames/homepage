...
`,pd={time:{value:0}};class UC extends Qt{constructor(t,n,s=24){super();Be(this,"preloader");Be(this,"tiles",new Qt);Be(this,"character");Be(this,"radius");Be(this,"plane",new St);this.preloader=t,this.character=n,this.radius=s}async preload(){for(let s=-this.radius/2;s<this.radius/2;s++)for(let r=-this.radius/2;r<this.radius/2;r++){if(Math.sqrt(s**2+r**2)>=this.radius/2)continue;const a=new Ad(this.preloader,10);a.position.set(s*10,0,r*10),this.tiles.add(a)}this.add(this.tiles);const t=new Ys(1e4,1e4,10,10),n=new Jn({color:11525888,side:An});this.plane=new St(t,n),this.plane.rotation.x=-Math.PI/2,this.add(this.plane),this.plane.updateMatrixWorld(),this.updateMatrixWorld()}render(){this.checkTiles(),this.movePlane(),this.tiles.children.forEach(t=>{t.render()})}movePlane(){this.plane.position.set(this.character.position.x,0,this.character.position.z)}checkTiles(){const t=Math.floor(this.character.position.x/10),n=Math.floor(this.character.position.z/10);this.tiles.children.forEach(s=>{Math.sqrt((s.position.x-t*10)**2+(s.position.z-n*10)**2)>=this.radius/2*10&&this.tiles.remove(s)});for(let s=-this.radius/2;s<this.radius/2;s++)for(let r=-this.radius/2;r<this.radius/2;r++){if(Math.sqrt(s**2+r**2)>=this.radius/2)continue;let a=!1;if(this.tiles.children.forEach(o=>{o.position.x===(t+s)*10&&o.position.z===(n+r)*10&&(a=!0)}),!a){const o=new Ad(this.preloader,10);o.position.set((t+s)*10,0,(n+r)*10),this.tiles.add(o)}}}}class NC extends Qt{constructor(t){super();Be(this,"preloader");Be(this,"clock",new Xl);Be(this,"mixer",new $h(new Qt));Be(this,"model",new Qt);Be(this,"gltf",{});Be(this,"walking",!0);this.preloader=t}async preload(){var n;await this.preloader.load([{id:"shibaInu",type:"gltf",url:"assets/three/models/shiba-inu.glb"}]),this.gltf=this.preloader.get("shibaInu"),this.model=this.gltf.scene,this.model.traverse(s=>{}),this.add(this.model),this.mixer=new $h(this.model);const t=this.gltf.animations.find(s=>s.name==="Shiba_Trot");t&&((n=this.mixer.clipAction(t))==null||n.play())}render(){var n;const t=this.clock.getDelta();this.walking&&((n=this.mixer)==null||n.update(t*1.5),this.position.z+=.2)}}class QC extends gA{constructor(t,n){super(t,n);Be(this,"cameraPerspective");Be(this,"cameraTop");Be(this,"character",new Qt);Be(this,"skybox",new St);Be(this,"ground",new St);Be(this,"lastCharacterPosition",new N);this.cameraPerspective=new Nt(75,window.innerWidth/window.innerHeight,.1,1e5),this.cameraTop=new Nt(75,window.innerWidth/window.innerHeight,.1,1e5),this.setCamera(this.cameraPerspective)}async setupCamera(){this.camera.position.set(0,50,50),this.cameraTop.position.set(0,100,0),this.cameraTop.lookAt(0,0,0)}async setupSkybox(){const t=new LC(this.preloader);this.addObject(t),this.skybox=t}async setupObjects(){this.character=new NC(this.preloader),this.addObject(this.character),this.ground=new UC(this.preloader,this.character),this.addObject(this.ground)}async setupLights(){const s=new Zf(16777215,3);this.addLight(s);const r=new Yl(16777215,1);r.position.set(0,10,0),r.shadow.mapSize.width=1024,r.shadow.mapSize.height=1024,r.shadow.camera.far=1e5,r.shadow.camera.near=.1,this.cameraPerspective.light=r,this.addLight(r)}setupControls(){super.setupControls(),this.controls.enableDamping=!0,this.controls.minPolarAngle=Math.PI*.465,this.controls.maxPolarAngle=.95*(Math.PI/2),this.controls.zoomSpeed=1,this.controls.maxDistance=25,this.controls.minDistance=15,this.controls.autoRotate=!0,this.controls.rotateSpeed=10}async render(){super.render(),this.cameraFollow(),this.lastCharacterPosition.copy(this.character.position)}toggleCamera(){this.setCamera(this.camera===this.cameraPerspective?this.cameraTop:this.cameraPerspective)}cameraFollow(){var n,s,r;const t=this.character.position.clone().sub(this.lastCharacterPosition);this.cameraTop.position.add(t),this.cameraPerspective.position.add(t),this.cameraPerspective.light.position.copy(this.cameraPerspective.position),(s=(n=this.cameraPerspective.light)==null?void 0:n.target)==null||s.position.copy(this.character.position),(r=this.controls)==null||r.target.copy(this.character.position)}}const OC={class:"w-full hero-section mt-[120px]"},kC=fe("div",{id:"three-hero"},null,-1),GC=fe("div",{class:"text-overlay w-full px-5 color-[#000]"},[fe("h1",{class:"lg:text-[64px] lg:leading-[64px] text-4xl font-bold text-center"},"Community-Driven Games"),fe("p",{class:"lg:text-2xl text-md text-center mt-5"},[At(" Play, earn, and grow within our ecosystem of crypto games. "),fe("br"),At(" Be a part of a game studio where players aren't just participants—they're partners. ")])],-1),HC=[kC,GC],zC=Mi({__name:"Hero",setup(i){return Or(()=>{const e=document.querySelector("#three-hero"),t=document.querySelector(".text-overlay");new QC(e,()=>{e.classList.add("fade-in"),t.classList.add("fade-in")})}),(e,t)=>(yt(),Vt("section",OC,HC))}}),VC="/images/community-gamers.png",xo=(i,e)=>{const t=i.__vccOpts||i;for(const[n,s]of e)t[n]=s;return t},WC={},qC={width:"22",height:"22",viewBox:"0 0 55 22",fill:"none",xmlns:"http://www.w3.org/2000/svg",class:"mt-1 ml-4"},jC=fe("path",{d:"M3.16667 11H51.8333M51.8333 11L39.6667 2.66666M51.8333 11L39.6667 19.3333",stroke:"currentcolor","stroke-width":"5","stroke-linecap":"round","stroke-linejoin":"round"},null,-1),KC=[jC];function YC(i,e){return yt(),Vt("svg",qC,KC)}const Qr=xo(WC,[["render",YC]]),XC={id:"idea",class:"px-5 w-full pb-[50px] pt-[100px] lg:pt-[100px] lg:pb-[150px] bg-[#feb14b] text-black pr-5 pl-5 lg:pr-0 lg:pl-0"},JC={class:"container lg:px-0 relative"},ZC={"data-aos":"fade-up",class:"flex flex-col md:flex-col lg:flex-col xl:flex-row items-center"},$C=fe("div",{class:"w-full lg:w-full xl:w-1/2 mt-0 lg:mt-5 text-center"},[fe("div",{class:"flex justify-center items-center text-center content-center"},[fe("img",{src:VC,alt:""})])],-1),ey={class:"w-full lg:w-full xl:w-1/2"},ty=fe("p",{class:"font font-light text-[18px] lg:text-[30px] leading-7 lg:leading-[41px] mb-[50px]"},[fe("b",null,"INUGAMES"),At(" is a community-driven game development studio that creates crypto games, from meme to casual games, that are fun, engaging, and addictive. "),fe("br"),fe("br"),At(" Our games are designed to be easy to pick up and play, with a focus on creating memorable experiences that keep players coming back for more. ")],-1),ny={href:"#games",class:"bg-black text-white hover:bg-white hover:text-black max-w-[260px] rounded-[8px] mt-[0px] flex text-xl leading-[16px] items-center justify-between px-[20px] py-[12px] duration-[0.3s] transition-all"},iy=Mi({__name:"Idea",setup(i){return(e,t)=>(yt(),Vt("section",XC,[fe("div",JC,[fe("div",ZC,[$C,fe("div",ey,[ty,fe("a",ny,[At(" 🕹️  Check Games! "),ht(Qr)])])])])]))}});class sy extends Qt{constructor(t,n){super();Be(this,"preloader");Be(this,"model",new Qt);Be(this,"gltf",{});this.preloader=t}async preload(){await this.preloader.load([{id:"inuCoin",type:"gltf",url:"assets/three/models/inu-coin.glb"}]),this.gltf=this.preloader.get("inuCoin"),this.model=this.gltf.scene.clone(),this.model.traverse(t=>{t instanceof St&&(t.material.metalness=.5,t.material.roughness=.25,t.material.envMapIntensity=.75,t.material.needsUpdate=!0)}),this.add(this.model)}render(){this.model.rotation.y+=.025,this.model.updateMatrix(),this.model.updateMatrixWorld(),this.updateMatrixWorld()}}class ry extends gA{constructor(t,n){super(t,n);Be(this,"cameraPerspective");Be(this,"coin");this.cameraPerspective=new Nt(45,window.innerWidth/window.innerHeight,1,100),this.setCamera(this.cameraPerspective)}async setupCamera(){this.camera.position.set(0,50,50)}async setupObjects(){this.coin=new sy(this.preloader,this.renderer),this.addObject(this.coin)}async setupLights(){const s=new Zf(16777215,4);this.addLight(s);const r=new Yl(16777215,1*2);r.position.set(10,0,3),this.addLight(r,0,0,0)}setupControls(){super.setupControls(),this.controls.enableDamping=!0,this.controls.minPolarAngle=Math.PI/2,this.controls.maxPolarAngle=Math.PI/2,this.controls.zoomSpeed=1,this.controls.maxDistance=7,this.controls.minDistance=7}}const ay={id:"token",class:"px-5 w-full pb-[50px] pt-[100px] lg:pt-[100px] lg:pb-[150px] bg-white text-black pr-5 pl-5 lg:pr-0 lg:pl-0"},oy={class:"container lg:px-0 relative"},cy={"data-aos":"fade-up",class:"flex flex-col md:flex-col lg:flex-col xl:flex-row-reverse items-center"},ly=fe("div",{class:"w-full lg:w-full xl:w-1/2 mt-0 lg:mt-5 text-center"},[fe("div",{id:"three-coin","data-aos":"fade-up"})],-1),uy={class:"font font-light text-[18px] lg:w-1/2 lg:text-[30px] leading-7 lg:leading-[41px] mb-[50px]"},hy=fe("p",{"data-aos":"fade-up"},[At(" We have deployed "),fe("b",null,"$INU"),At(" on the Ethereum network to power our game ecosystem. "),fe("br"),fe("br"),fe("b",null,"$INU"),At(" is a utility token that can be used within the "),fe("b",null,"INUGAMES"),At(" ecosystem. It can also be staked and rewards holders with virtual currencies of each game, and can be used for governance to decide how each game is developed. "),fe("br"),fe("br"),At(" 0x64669032f612Ae608671853fF8871dF0889870A9 ")],-1),dy={"data-aos":"fade-up",class:"flex flex-col lg:flex-row gap-[21px] mt-[75px]"},fy={target:"_blank",href:"https://app.uniswap.org/swap?chain=mainnet&inputCurrency=NATIVE&outputCurrency=0x64669032f612Ae608671853fF8871dF0889870A9",class:"bg-[#fdb04b] text-white hover:bg-black hover:text-white max-w-[260px] rounded-[8px] mt-[0px] flex text-xl leading-[16px] items-center justify-between px-[20px] py-[12px] duration-[0.3s] transition-all"},Ay=Mi({__name:"Token",setup(i){return Or(()=>{new ry(document.querySelector("#three-coin"),()=>{})}),(e,t)=>(yt(),Vt("section",ay,[fe("div",oy,[fe("div",cy,[ly,fe("div",uy,[hy,fe("div",dy,[fe("a",fy,[At("  Buy Now! "),ht(Qr)])])])])])]))}}),py="/images/shiba-wif-hoodie.png",mA=i=>(Ep("data-v-e39e3da4"),i=i(),xp(),i),gy={id:"community",class:"px-5 w-full pb-[50px] pt-[100px] lg:pt-[100px] lg:pb-[150px] bg-[#feb14b] text-black pr-5 pl-5 lg:pr-0 lg:pl-0"},my={class:"container lg:px-0 relative"},_y={"data-aos":"fade-up",class:"flex flex-col md:flex-col lg:flex-col xl:flex-row items-center"},by=mA(()=>fe("div",{class:"w-full lg:w-full xl:w-1/2 mt-0 lg:mt-5 text-center"},[fe("div",{class:"flex justify-center items-center text-center content-center pr-10"},[fe("img",{src:py,class:"w-full animated-image"})])],-1)),Ey={class:"w-full lg:w-full xl:w-1/2"},xy=mA(()=>fe("p",{class:"font font-light text-[18px] lg:text-[30px] leading-7 lg:leading-[41px] mb-[50px]"},[fe("h2",{"data-aos":"fade-up",class:"text-center font-bold leading-[87px] text-[50px] lg:text-[64px]"}," Join Us! "),At(" We want our members to be able to participate in the development of our games, so we have created a community where you can share your ideas, feedback, and suggestions. "),fe("br"),fe("br"),At(" Use our Telegram group to chat with other members, participate in polls, and get the latest updates on our games. ")],-1)),vy={target:"_blank",href:"https://t.me/inudotgames",class:"m-auto mt-4 text-center bg-black text-white hover:bg-white hover:text-black max-w-[260px] rounded-[8px] flex text-xl leading-[16px] items-center justify-between px-[20px] py-[12px] duration-[0.3s] transition-all"},Iy=Mi({__name:"Community",setup(i){return(e,t)=>(yt(),Vt("section",gy,[fe("div",my,[fe("div",_y,[by,fe("div",Ey,[xy,fe("a",vy,[At(" 🕹️  Participate Now! "),ht(Qr)])])])])]))}}),Cy=xo(Iy,[["__scopeId","data-v-e39e3da4"]]),yy="/images/telegram.svg",Sy="/images/x.svg",My="/images/dextools.svg",wy="/images/email.svg",By="/images/github.svg",Ty={},Ry={class:"bg-black py-16"},Dy=cf('<div class="container flex justify-center"><div class="w-auto"><ul class="flex gap-x-[30px] mt-[15px]"><a target="_blank" href="https://t.me/inudotgames"><img width="35" height="35" src="'+yy+'" alt="Telegram Icon"></a><a target="_blank" href="https://x.com/inudotgames"><img width="35" height="35" src="'+Sy+'" alt="Github Icon"></a><a target="_blank" href="https://www.dextools.io/app/en/ether/pair-explorer/0x58a63a150888c3399d00a0e2c64be8c3d2e88dcb"><img width="28" height="28" src="'+My+'" alt="Dextools Icon"></a><a target="_blank" href="mailto:dev@inu.games"><img width="34" height="34" src="'+wy+'" alt="Email Icon"></a><a target="_blank" href="https://github.com/inudotgames"><img width="34" height="34" src="'+By+'" alt="X Icon"></a></ul></div></div><div class="text-center text-white pt-5"> INUGAMES © 2024 </div>',2),Ly=[Dy];function Py(i,e){return yt(),Vt("footer",Ry,Ly)}const Fy=xo(Ty,[["render",Py]]),Uy="/images/game-process.png",Ny="/images/game-shiba-island.png",Qy="/images/game-meme-wars.png",Oy={id:"games",class:"px-5 w-full pt-[30px] lg:pt-[100px] pb-[0px] lg:pb-[70px] bg-[#000000]"},ky={class:"container lg:px-0"},Gy=fe("h1",{class:"text-center font-semibold leading-[50px] lg:leading-[87px] text-3xl lg:text-[64px] text-white","data-aos":"fade-up"}," Our Games ",-1),Hy=fe("div",null,[fe("p",{class:"text-center text-white font-light text-[18px] lg:text-[30px] leading-7 lg:leading-[41px] mt-[20px]","data-aos":"fade-up"},[fe("img",{class:"m-auto",src:Uy}),At(" Each game is crafted with love and care by our team of developers and designers. "),fe("br"),At(" We start "),fe("b",null,"simple"),At(" and build upon the "),fe("b",null,"feedback of our community"),At(" to create the "),fe("b",null,"best gaming"),At(" experience. ")])],-1),zy={class:"flex flex-col lg:flex-row gap-[20px] mt-[20px] lg:mt-[50px] text-center"},Vy={class:"w-full lg:w-1/2"},Wy=fe("p",{class:"font-light text-[18px] lg:text-[30px] leading-7 lg:leading-[41px] mb-[50px]","data-aos":"fade-up"},[fe("h2",{class:"font-bold font-4xl"},"Shiba Island"),fe("br"),fe("img",{class:"m-auto max-w-[350px]",src:Ny}),fe("br"),fe("p",{class:"font-light max-w-[350px] text-[18px] lg:text-[24px] leading-7 lg:leading-[41px] m-auto","data-aos":"fade-up"}," Farm, Collect & Trade with other players. Build your own island and collaborate with others! ")],-1),qy={target:"_blank",href:"https://t.me/shibaisland",class:"m-auto mt-4 text-center bg-white text-black hover:bg-[#fdb04b] hover:text-black max-w-[260px] rounded-[8px] flex text-xl leading-[16px] items-center justify-between px-[20px] py-[12px] duration-[0.3s] transition-all"},jy={class:"w-full lg:w-1/2"},Ky=fe("p",{class:"font-light text-[18px] lg:text-[30px] leading-7 lg:leading-[41px] mb-[50px]","data-aos":"fade-up"},[fe("h2",{class:"font-bold font-4xl"},"Meme Wars"),fe("br"),fe("img",{class:"m-auto max-w-[350px]",src:Qy}),fe("br"),fe("p",{class:"font-light max-w-[350px] text-[18px] lg:text-[24px] leading-7 lg:leading-[41px] m-auto","data-aos":"fade-up"}," Fight to be the last one standing in this battle royale game using your favorite meme characters! ")],-1),Yy={class:"m-auto mt-4 text-center bg-white text-black hover:bg-[#aaa] cursor-pointer hover:text-black max-w-[260px] rounded-[8px] flex text-xl leading-[16px] items-center justify-between px-[20px] py-[12px] duration-[0.3s] transition-all"},Xy=Mi({__name:"Games",setup(i){return(e,t)=>(yt(),Vt("section",Oy,[fe("div",ky,[Gy,Hy,fe("div",zy,[fe("div",Vy,[Wy,fe("a",qy,[At(" 🕹️  Early Access "),ht(Qr)])]),fe("div",jy,[Ky,fe("a",Yy,[At(" 🕹️  Coming Soon "),ht(Qr,{class:"invisible"})])])])])]))}}),Jy="/images/inugames-icon.svg",Zy={},$y={class:"spinner"},eS=fe("div",null,[fe("img",{class:"inu-icon",src:Jy,alt:"Inu Icon",width:"200"})],-1),tS=[eS];function nS(i,e){return yt(),Vt("div",$y,tS)}const iS=xo(Zy,[["render",nS]]),sS={key:1},rS=Mi({__name:"App",setup(i){const e=Et(!0),t=async()=>{await new Promise(n=>{setTimeout(n,1500)}),e.value=!1};return Or(()=>{lm.init(),t()}),(n,s)=>(yt(),Vt("div",null,[e.value?(yt(),Ml(iS,{key:0})):xr("",!0),e.value?xr("",!0):(yt(),Vt("div",sS,[ht(bm),ht(zC),ht(iy),ht(Xy),ht(Ay),ht(Cy),ht(Fy)]))]))}});qg(rS).use(rm).mount("#app");
