...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Ii,depthTest:!1,depthWrite:!1})}function gh(){return new ni({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:zl(),fragmentShader:`
		...
		`,blending:Ii,depthTest:!1,depthWrite:!1})}function mh(){return new ni({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:zl(),fragmentShader:`
	...
	`}function Y0(i){let e=new WeakMap,t=null;function n(o){if(o&&o.isTexture){const c=o.mapping,l=c===Fc||c===Uc,u=c===Ki||c===Qs;if(l||u){let h=e.get(o);const d=h!==void 0?h.texture.pmremVersion:0;if(o.isRenderTargetTexture&&o.pmremVersion!==d)return t===null&&(t=new Ah(i)),h=l?t.fromEquirectangular(o,h):t.fromCubemap(o,h),h.texture.pmremVersion=o.pmremVersion,e.set(o,h),h.texture;if(h!==void 0)return h.texture;{const f=o.image;return l&&f&&f.height>0||u&&f&&s(f)?(t===null&&(t=new Ah(i)),h=l?t.fromEquirectangular(o):t.fromCubemap(o),h.texture.pmremVersion=o.pmremVersion,e.set(o,h),o.addEventListener("dispose",r),h.texture):null}}}return o}function s(o){let c=0;const l=6;for(let u=0;u<l;u++)o[u]!==void 0&&c++;return c===l}function r(o){const c=o.target;c.removeEventListener("dispose",r);const l=e.get(c);l!==void 0&&(e.delete(c),l.dispose())}function a(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:a}}function X0(i){const e={};function t(n){if(e[n]!==void 0)return e[n];let s;switch(n){case"WEBGL_depth_texture":s=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":s=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":s=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":s=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:s=i.getExtension(n)}return e[n]=s,s}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const s=t(n);return s===null&&Rs("THREE.WebGLRenderer: "+n+" extension not supported."),s}}}function J0(i,e,t,n){const s={},r=new WeakMap;function a(h){const d=h.target;d.index!==null&&e.remove(d.index);for(const g in d.attributes)e.remove(d.attributes[g]);for(const g in d.morphAttributes){const m=d.morphAttributes[g];for(let p=0,A=m.length;p<A;p++)e.remove(m[p])}d.removeEventListener("dispose",a),delete s[d.id];const f=r.get(d);f&&(e.remove(f),r.delete(d)),n.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,t.memory.geometries--}function o(h,d){return s[d.id]===!0||(d.addEventListener("dispose",a),s[d.id]=!0,t.memory.geometries++),d}function c(h){const d=h.attributes;for(const g in d)e.update(d[g],i.ARRAY_BUFFER);const f=h.morphAttributes;for(const g in f){const m=f[g];for(let p=0,A=m.length;p<A;p++)e.update(m[p],i.ARRAY_BUFFER)}}function l(h){const d=[],f=h.index,g=h.attributes.position;let m=0;if(f!==null){const x=f.array;m=f.version;for(let b=0,I=x.length;b<I;b+=3){const P=x[b+0],M=x[b+1],B=x[b+2];d.push(P,M,M,B,B,P)}}else if(g!==void 0){const x=g.array;m=g.version;for(let b=0,I=x.length/3-1;b<I;b+=3){const P=b+0,M=b+1,B=b+2;d.push(P,M,M,B,B,P)}}else return;const p=new(wf(d)?Ff:Pf)(d,1);p.version=m;const A=r.get(h);A&&e.remove(A),r.set(h,p)}function u(h){const d=r.get(h);if(d){const f=h.index;f!==null&&d.version<f.version&&l(h)}else l(h);return r.get(h)}return{get:o,update:c,getWireframeAttribute:u}}function $0(i,e,t){let n;function s(d){n=d}let r,a;function o(d){r=d.type,a=d.bytesPerElement}function c(d,f){i.drawElements(n,f,r,d*a),t.update(f,n,1)}function l(d,f,g){g!==0&&(i.drawElementsInstanced(n,f,r,d*a,g),t.update(f,n,g))}function u(d,f,g){if(g===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,f,0,r,d,0,g);let p=0;for(let A=0;A<g;A++)p+=f[A];t.update(p,n,1)}function h(d,f,g,m){if(g===0)return;const p=e.get("WEBGL_multi_draw");if(p===null)for(let A=0;A<d.length;A++)l(d[A]/a,f[A],m[A]);else{p.multiDrawElementsInstancedWEBGL(n,f,0,r,d,0,m,0,g);let A=0;for(let x=0;x<g;x++)A+=f[x];for(let x=0;x<m.length;x++)t.update(A,n,m[x])}}this.setMode=s,this.setIndex=o,this.render=c,this.renderInstances=l,this.renderMultiDraw=u,this.renderMultiDrawInstances=h}function Z0(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,a,o){switch(t.calls++,a){case i.TRIANGLES:t.triangles+=o*(r/3);break;case i.LINES:t.lines+=o*(r/2);break;case i.LINE_STRIP:t.lines+=o*(r-1);break;case i.LINE_LOOP:t.lines+=o*r;break;case i.POINTS:t.points+=o*r;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",a);break}}function s(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:s,update:n}}function ex(i,e,t){const n=new WeakMap,s=new ot;function r(a,o,c){const l=a.morphTargetInfluences,u=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,h=u!==void 0?u.length:0;let d=n.get(o);if(d===void 0||d.count!==h){let v=function(){F.dispose(),n.delete(o),o.removeEventListener("dispose",v)};var f=v;d!==void 0&&d.texture.dispose();const g=o.morphAttributes.position!==void 0,m=o.morphAttributes.normal!==void 0,p=o.morphAttributes.color!==void 0,A=o.morphAttributes.position||[],x=o.morphAttributes.normal||[],b=o.morphAttributes.color||[];let I=0;g===!0&&(I=1),m===!0&&(I=2),p===!0&&(I=3);let P=o.attributes.position.count*I,M=1;P>e.maxTextureSize&&(M=Math.ceil(P/e.maxTextureSize),P=e.maxTextureSize);const B=new Float32Array(P*M*4*h),F=new Tf(B,P,M,h);F.type=$t,F.needsUpdate=!0;const S=I*4;for(let T=0;T<h;T++){const U=A[T],Q=x[T],q=b[T],ee=P*M*4*T;for(let W=0;W<U.count;W++){const j=W*S;g===!0&&(s.fromBufferAttribute(U,W),B[ee+j+0]=s.x,B[ee+j+1]=s.y,B[ee+j+2]=s.z,B[ee+j+3]=0),m===!0&&(s.fromBufferAttribute(Q,W),B[ee+j+4]=s.x,B[ee+j+5]=s.y,B[ee+j+6]=s.z,B[ee+j+7]=0),p===!0&&(s.fromBufferAttribute(q,W),B[ee+j+8]=s.x,B[ee+j+9]=s.y,B[ee+j+10]=s.z,B[ee+j+11]=q.itemSize===4?s.w:1)}}d={count:h,texture:F,size:new Ne(P,M)},n.set(o,d),o.addEventListener("dispose",v)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)c.getUniforms().setValue(i,"morphTexture",a.morphTexture,t);else{let g=0;for(let p=0;p<l.length;p++)g+=l[p];const m=o.morphTargetsRelative?1:1-g;c.getUniforms().setValue(i,"morphTargetBaseInfluence",m),c.getUniforms().setValue(i,"morphTargetInfluences",l)}c.getUniforms().setValue(i,"morphTargetsTexture",d.texture,t),c.getUniforms().setValue(i,"morphTargetsTextureSize",d.size)}return{update:r}}function tx(i,e,t,n){let s=new WeakMap;function r(c){const l=n.render.frame,u=c.geometry,h=e.get(c,u);if(s.get(h)!==l&&(e.update(h),s.set(h,l)),c.isInstancedMesh&&(c.hasEventListener("dispose",o)===!1&&c.addEventListener("dispose",o),s.get(c)!==l&&(t.update(c.instanceMatrix,i.ARRAY_BUFFER),c.instanceColor!==null&&t.update(c.instanceColor,i.ARRAY_BUFFER),s.set(c,l))),c.isSkinnedMesh){const d=c.skeleton;s.get(d)!==l&&(d.update(),s.set(d,l))}return h}function a(){s=new WeakMap}function o(c){const l=c.target;l.removeEventListener("dispose",o),t.remove(l.instanceMatrix),l.instanceColor!==null&&t.remove(l.instanceColor)}return{update:r,dispose:a}}class Of extends St{constructor(e,t,n,s,r,a,o,c,l,u=Ts){if(u!==Ts&&u!==Gs)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&u===Ts&&(n=Yi),n===void 0&&u===Gs&&(n=ks),super(null,s,r,a,o,c,u,n,l),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=o!==void 0?o:Jt,this.minFilter=c!==void 0?c:Jt,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}}const kf=new St,_h=new Of(1,1),Gf=new Tf,Hf=new Rf,zf=new Nf,bh=[],Eh=[],xh=new Float32Array(16),vh=new Float32Array(9),Ih=new Float32Array(4);function Js(i,e,t){const n=i[0];if(n<=0||n>0)return i;const s=e*t;let r=bh[s];if(r===void 0&&(r=new Float32Array(s),bh[s]=r),e!==0){n.toArray(r,0);for(let a=1,o=0;a!==e;++a)o+=t,i[a].toArray(r,o)}return r}function wt(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function Bt(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function _o(i,e){let t=Eh[e];t===void 0&&(t=new Int32Array(e),Eh[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function nx(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function ix(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(wt(t,e))return;i.uniform2fv(this.addr,e),Bt(t,e)}}function sx(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(wt(t,e))return;i.uniform3fv(this.addr,e),Bt(t,e)}}function rx(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(wt(t,e))return;i.uniform4fv(this.addr,e),Bt(t,e)}}function ax(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(wt(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),Bt(t,e)}else{if(wt(t,n))return;Ih.set(n),i.uniformMatrix2fv(this.addr,!1,Ih),Bt(t,n)}}function ox(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(wt(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),Bt(t,e)}else{if(wt(t,n))return;vh.set(n),i.uniformMatrix3fv(this.addr,!1,vh),Bt(t,n)}}function cx(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(wt(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),Bt(t,e)}else{if(wt(t,n))return;xh.set(n),i.uniformMatrix4fv(this.addr,!1,xh),Bt(t,n)}}function lx(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function ux(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(wt(t,e))return;i.uniform2iv(this.addr,e),Bt(t,e)}}function hx(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(wt(t,e))return;i.uniform3iv(this.addr,e),Bt(t,e)}}function dx(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(wt(t,e))return;i.uniform4iv(this.addr,e),Bt(t,e)}}function fx(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function Ax(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(wt(t,e))return;i.uniform2uiv(this.addr,e),Bt(t,e)}}function px(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(wt(t,e))return;i.uniform3uiv(this.addr,e),Bt(t,e)}}function gx(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(wt(t,e))return;i.uniform4uiv(this.addr,e),Bt(t,e)}}function mx(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s);let r;this.type===i.SAMPLER_2D_SHADOW?(_h.compareFunction=Sf,r=_h):r=kf,t.setTexture2D(e||r,s)}function _x(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture3D(e||Hf,s)}function bx(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTextureCube(e||zf,s)}function Ex(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture2DArray(e||Gf,s)}function xx(i){switch(i){case 5126:return nx;case 35664:return ix;case 35665:return sx;case 35666:return rx;case 35674:return ax;case 35675:return ox;case 35676:return cx;case 5124:case 35670:return lx;case 35667:case 35671:return ux;case 35668:case 35672:return hx;case 35669:case 35673:return dx;case 5125:return fx;case 36294:return Ax;case 36295:return px;case 36296:return gx;case 35678:case 36198:case 36298:case 36306:case 35682:return mx;case 35679:case 36299:case 36307:return _x;case 35680:case 36300:case 36308:case 36293:return bx;case 36289:case 36303:case 36311:case 36292:return Ex}}function vx(i,e){i.uniform1fv(this.addr,e)}function Ix(i,e){const t=Js(e,this.size,2);i.uniform2fv(this.addr,t)}function Cx(i,e){const t=Js(e,this.size,3);i.uniform3fv(this.addr,t)}function yx(i,e){const t=Js(e,this.size,4);i.uniform4fv(this.addr,t)}function Sx(i,e){const t=Js(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function Mx(i,e){const t=Js(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function wx(i,e){const t=Js(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function Bx(i,e){i.uniform1iv(this.addr,e)}function Tx(i,e){i.uniform2iv(this.addr,e)}function Rx(i,e){i.uniform3iv(this.addr,e)}function Dx(i,e){i.uniform4iv(this.addr,e)}function Lx(i,e){i.uniform1uiv(this.addr,e)}function Px(i,e){i.uniform2uiv(this.addr,e)}function Fx(i,e){i.uniform3uiv(this.addr,e)}function Ux(i,e){i.uniform4uiv(this.addr,e)}function Nx(i,e,t){const n=this.cache,s=e.length,r=_o(t,s);wt(n,r)||(i.uniform1iv(this.addr,r),Bt(n,r));for(let a=0;a!==s;++a)t.setTexture2D(e[a]||kf,r[a])}function Qx(i,e,t){const n=this.cache,s=e.length,r=_o(t,s);wt(n,r)||(i.uniform1iv(this.addr,r),Bt(n,r));for(let a=0;a!==s;++a)t.setTexture3D(e[a]||Hf,r[a])}function Ox(i,e,t){const n=this.cache,s=e.length,r=_o(t,s);wt(n,r)||(i.uniform1iv(this.addr,r),Bt(n,r));for(let a=0;a!==s;++a)t.setTextureCube(e[a]||zf,r[a])}function kx(i,e,t){const n=this.cache,s=e.length,r=_o(t,s);wt(n,r)||(i.uniform1iv(this.addr,r),Bt(n,r));for(let a=0;a!==s;++a)t.setTexture2DArray(e[a]||Gf,r[a])}function Gx(i){switch(i){case 5126:return vx;case 35664:return Ix;case 35665:return Cx;case 35666:return yx;case 35674:return Sx;case 35675:return Mx;case 35676:return wx;case 5124:case 35670:return Bx;case 35667:case 35671:return Tx;case 35668:case 35672:return Rx;case 35669:case 35673:return Dx;case 5125:return Lx;case 36294:return Px;case 36295:return Fx;case 36296:return Ux;case 35678:case 36198:case 36298:case 36306:case 35682:return Nx;case 35679:case 36299:case 36307:return Qx;case 35680:case 36300:case 36308:case 36293:return Ox;case 36289:case 36303:case 36311:case 36292:return kx}}class Hx{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=xx(t.type)}}class zx{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=Gx(t.type)}}class Vx{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const s=this.seq;for(let r=0,a=s.length;r!==a;++r){const o=s[r];o.setValue(e,t[o.id],n)}}}const ic=/(\w+)(\])?(\[|\.)?/g;function Ch(i,e){i.seq.push(e),i.map[e.id]=e}function Wx(i,e,t){const n=i.name,s=n.length;for(ic.lastIndex=0;;){const r=ic.exec(n),a=ic.lastIndex;let o=r[1];const c=r[2]==="]",l=r[3];if(c&&(o=o|0),l===void 0||l==="["&&a+2===s){Ch(t,l===void 0?new Hx(o,i,e):new zx(o,i,e));break}else{let h=t.map[o];h===void 0&&(h=new Vx(o),Ch(t,h)),t=h}}}class Fa{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let s=0;s<n;++s){const r=e.getActiveUniform(t,s),a=e.getUniformLocation(t,r.name);Wx(r,a,this)}}setValue(e,t,n,s){const r=this.map[t];r!==void 0&&r.setValue(e,n,s)}setOptional(e,t,n){const s=t[n];s!==void 0&&this.setValue(e,n,s)}static upload(e,t,n,s){for(let r=0,a=t.length;r!==a;++r){const o=t[r],c=n[o.id];c.needsUpdate!==!1&&o.setValue(e,c.value,s)}}static seqWithValue(e,t){const n=[];for(let s=0,r=e.length;s!==r;++s){const a=e[s];a.id in t&&n.push(a)}return n}}function yh(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}const qx=37297;let jx=0;function Kx(i,e){const t=i.split(`
`),n=[],s=Math.max(e-6,0),r=Math.min(e+6,t.length);for(let a=s;a<r;a++){const o=a+1;n.push(`${o===e?">":" "} ${o}: ${t[a]}`)}return n.join(`
`)}function Yx(i){const e=et.getPrimaries(et.workingColorSpace),t=et.getPrimaries(i);let n;switch(e===t?n="":e===$a&&t===Ja?n="LinearDisplayP3ToLinearSRGB":e===Ja&&t===$a&&(n="LinearSRGBToLinearDisplayP3"),i){case Mt:case Gr:return[n,"LinearTransferOETF"];case It:case mo:return[n,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",i),[n,"LinearTransferOETF"]}}function Sh(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),s=i.getShaderInfoLog(e).trim();if(n&&s==="")return"";const r=/ERROR: 0:(\d+)/.exec(s);if(r){const a=parseInt(r[1]);return t.toUpperCase()+`

`+s+`

`+Kx(i.getShaderSource(e),a)}else return s}function Xx(i,e){const t=Yx(e);return`vec4 ${i}( vec4 value ) { return ${t[0]}( ${t[1]}( value ) ); }`}function Jx(i,e){let t;switch(e){case Xm:t="Linear";break;case Jm:t="Reinhard";break;case $m:t="OptimizedCineon";break;case Zm:t="ACESFilmic";break;case t_:t="AgX";break;case n_:t="Neutral";break;case e_:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const _a=new N;function $x(){et.getLuminanceCoefficients(_a);const i=_a.x.toFixed(4),e=_a.y.toFixed(4),t=_a.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`)}function tv(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){const r=i.getActiveAttrib(e,s),a=r.name;let o=1;r.type===i.FLOAT_MAT2&&(o=2),r.type===i.FLOAT_MAT3&&(o=3),r.type===i.FLOAT_MAT4&&(o=4),t[a]={type:r.type,location:i.getAttribLocation(e,a),locationSize:o}}return t}function pr(i){return i!==""}function Mh(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function wh(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const nv=/^[ \t]*#include +<([\w\d./]+)>/gm;function sl(i){return i.replace(nv,sv)}const iv=new Map;function sv(i,e){let t=We[e];if(t===void 0){const n=iv.get(e);if(n!==void 0)t=We[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return sl(t)}const rv=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Bh(i){return i.replace(rv,av)}function av(i,e,t,n){let s="";for(let r=parseInt(e);r<parseInt(t);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function Th(i){let e=`precision ${i.precision} float;
...
`,gd={time:{value:0}};class UC extends Qt{constructor(t,n,s=24){super();Be(this,"preloader");Be(this,"tiles",new Qt);Be(this,"character");Be(this,"radius");Be(this,"plane",new yt);this.preloader=t,this.character=n,this.radius=s}async preload(){for(let s=-this.radius/2;s<this.radius/2;s++)for(let r=-this.radius/2;r<this.radius/2;r++){if(Math.sqrt(s**2+r**2)>=this.radius/2)continue;const a=new pd(this.preloader,10);a.position.set(s*10,0,r*10),this.tiles.add(a)}this.add(this.tiles);const t=new Xs(1e4,1e4,10,10),n=new Jn({color:11525888,side:An});this.plane=new yt(t,n),this.plane.rotation.x=-Math.PI/2,this.add(this.plane),this.plane.updateMatrixWorld(),this.updateMatrixWorld()}render(){this.checkTiles(),this.movePlane(),this.tiles.children.forEach(t=>{t.render()})}movePlane(){this.plane.position.set(this.character.position.x,0,this.character.position.z)}checkTiles(){const t=Math.floor(this.character.position.x/10),n=Math.floor(this.character.position.z/10);this.tiles.children.forEach(s=>{Math.sqrt((s.position.x-t*10)**2+(s.position.z-n*10)**2)>=this.radius/2*10&&this.tiles.remove(s)});for(let s=-this.radius/2;s<this.radius/2;s++)for(let r=-this.radius/2;r<this.radius/2;r++){if(Math.sqrt(s**2+r**2)>=this.radius/2)continue;let a=!1;if(this.tiles.children.forEach(o=>{o.position.x===(t+s)*10&&o.position.z===(n+r)*10&&(a=!0)}),!a){const o=new pd(this.preloader,10);o.position.set((t+s)*10,0,(n+r)*10),this.tiles.add(o)}}}}class NC extends Qt{constructor(t){super();Be(this,"preloader");Be(this,"clock",new Jl);Be(this,"mixer",new ed(new Qt));Be(this,"model",new Qt);Be(this,"gltf",{});Be(this,"walking",!0);this.preloader=t}async preload(){var n;await this.preloader.load([{id:"shibaInu",type:"gltf",url:"assets/three/models/shiba-inu.glb"}]),this.gltf=this.preloader.get("shibaInu"),this.model=this.gltf.scene,this.model.traverse(s=>{}),this.add(this.model),this.mixer=new ed(this.model);const t=this.gltf.animations.find(s=>s.name==="Shiba_Trot");t&&((n=this.mixer.clipAction(t))==null||n.play())}render(){var n;const t=this.clock.getDelta();this.walking&&((n=this.mixer)==null||n.update(t*1.5),this.position.z+=.2)}}class QC extends gA{constructor(t,n){super(t,n);Be(this,"cameraPerspective");Be(this,"cameraTop");Be(this,"character",new Qt);Be(this,"skybox",new yt);Be(this,"ground",new yt);Be(this,"lastCharacterPosition",new N);this.cameraPerspective=new Nt(75,window.innerWidth/window.innerHeight,.1,1e5),this.cameraTop=new Nt(75,window.innerWidth/window.innerHeight,.1,1e5),this.setCamera(this.cameraPerspective)}async setupCamera(){this.camera.position.set(0,50,50),this.cameraTop.position.set(0,100,0),this.cameraTop.lookAt(0,0,0)}async setupSkybox(){const t=new LC(this.preloader);this.addObject(t),this.skybox=t}async setupObjects(){this.character=new NC(this.preloader),this.addObject(this.character),this.ground=new UC(this.preloader,this.character),this.addObject(this.ground)}async setupLights(){const s=new $f(16777215,3);this.addLight(s);const r=new Xl(16777215,1);r.position.set(0,10,0),r.shadow.mapSize.width=1024,r.shadow.mapSize.height=1024,r.shadow.camera.far=1e5,r.shadow.camera.near=.1,this.cameraPerspective.light=r,this.addLight(r)}setupControls(){super.setupControls(),this.controls.enableDamping=!0,this.controls.minPolarAngle=Math.PI*.465,this.controls.maxPolarAngle=.95*(Math.PI/2),this.controls.zoomSpeed=1,this.controls.maxDistance=25,this.controls.minDistance=15,this.controls.autoRotate=!0,this.controls.rotateSpeed=10}async render(){super.render(),this.cameraFollow(),this.lastCharacterPosition.copy(this.character.position)}toggleCamera(){this.setCamera(this.camera===this.cameraPerspective?this.cameraTop:this.cameraPerspective)}cameraFollow(){var n,s,r;const t=this.character.position.clone().sub(this.lastCharacterPosition);this.cameraTop.position.add(t),this.cameraPerspective.position.add(t),this.cameraPerspective.light.position.copy(this.cameraPerspective.position),(s=(n=this.cameraPerspective.light)==null?void 0:n.target)==null||s.position.copy(this.character.position),(r=this.controls)==null||r.target.copy(this.character.position)}}const OC={class:"w-full hero-section mt-[120px]"},kC=pe("div",{id:"three-hero"},null,-1),GC=pe("div",{class:"text-overlay w-full px-5 color-[#000]"},[pe("h1",{class:"lg:text-[64px] lg:leading-[64px] text-4xl font-bold text-center"},"Community-Driven Games"),pe("p",{class:"lg:text-2xl text-sm text-md text-center mt-5"},[Rt(" Play, earn, and grow within our ecosystem of crypto games. "),pe("br"),Rt(" Be a part of a game studio where players aren't just participants—they're partners. ")])],-1),HC=[kC,GC],zC=Mi({__name:"Hero",setup(i){return Or(()=>{const e=document.querySelector("#three-hero"),t=document.querySelector(".text-overlay");new QC(e,()=>{e.classList.add("fade-in"),t.classList.add("fade-in")})}),(e,t)=>(Ct(),Vt("section",OC,HC))}}),VC="/images/community-gamers.png",xo=(i,e)=>{const t=i.__vccOpts||i;for(const[n,s]of e)t[n]=s;return t},WC={},qC={width:"22",height:"22",viewBox:"0 0 55 22",fill:"none",xmlns:"http://www.w3.org/2000/svg",class:"mt-1 ml-4"},jC=pe("path",{d:"M3.16667 11H51.8333M51.8333 11L39.6667 2.66666M51.8333 11L39.6667 19.3333",stroke:"currentcolor","stroke-width":"5","stroke-linecap":"round","stroke-linejoin":"round"},null,-1),KC=[jC];function YC(i,e){return Ct(),Vt("svg",qC,KC)}const js=xo(WC,[["render",YC]]),XC={id:"idea",class:"px-5 w-full pb-[50px] pt-[100px] lg:pt-[100px] lg:pb-[150px] bg-[#feb14b] text-black pr-5 pl-5 lg:pr-0 lg:pl-0"},JC={class:"container lg:px-0 relative"},$C={"data-aos":"fade-up",class:"flex flex-col md:flex-col lg:flex-col xl:flex-row items-center"},ZC=pe("div",{class:"w-full lg:w-full xl:w-1/2 mt-0 lg:mt-5 text-center"},[pe("div",{class:"flex justify-center items-center text-center content-center"},[pe("img",{src:VC,alt:""})])],-1),ey={class:"w-full lg:w-full xl:w-1/2"},ty=pe("p",{class:"font font-light text-[18px] lg:text-[30px] leading-7 lg:leading-[41px] mb-[50px]"},[pe("b",null,"INUGAMES"),Rt(" is a community-driven game development studio that creates crypto games, from meme to casual games, that are fun, engaging, and addictive. "),pe("br"),pe("br"),Rt(" Our games are designed to be easy to pick up and play, with a focus on creating memorable experiences that keep players coming back for more. ")],-1),ny={href:"#games",class:"bg-black text-white hover:bg-white hover:text-black max-w-[260px] rounded-[8px] mt-[0px] flex text-xl leading-[16px] items-center justify-between px-[20px] py-[12px] duration-[0.3s] transition-all"},iy=Mi({__name:"Idea",setup(i){return(e,t)=>(Ct(),Vt("section",XC,[pe("div",JC,[pe("div",$C,[ZC,pe("div",ey,[ty,pe("a",ny,[Rt(" 🕹️  Check Games! "),ut(js)])])])])]))}});class sy extends Qt{constructor(t,n){super();Be(this,"preloader");Be(this,"model",new Qt);Be(this,"gltf",{});this.preloader=t}async preload(){await this.preloader.load([{id:"inuCoin",type:"gltf",url:"assets/three/models/inu-coin.glb"}]),this.gltf=this.preloader.get("inuCoin"),this.model=this.gltf.scene.clone(),this.model.traverse(t=>{t instanceof yt&&(t.material.metalness=.5,t.material.roughness=.25,t.material.envMapIntensity=.75,t.material.needsUpdate=!0)}),this.add(this.model)}render(){this.model.rotation.y+=.025,this.model.updateMatrix(),this.model.updateMatrixWorld(),this.updateMatrixWorld()}}class ry extends gA{constructor(t,n){super(t,n);Be(this,"cameraPerspective");Be(this,"coin");this.cameraPerspective=new Nt(45,window.innerWidth/window.innerHeight,1,100),this.setCamera(this.cameraPerspective)}async setupCamera(){this.camera.position.set(0,50,50)}async setupObjects(){this.coin=new sy(this.preloader,this.renderer),this.addObject(this.coin)}async setupLights(){const s=new $f(16777215,4);this.addLight(s);const r=new Xl(16777215,1*2);r.position.set(10,0,3),this.addLight(r,0,0,0)}setupControls(){super.setupControls(),this.controls.enableDamping=!0,this.controls.minPolarAngle=Math.PI/2,this.controls.maxPolarAngle=Math.PI/2,this.controls.zoomSpeed=1,this.controls.maxDistance=7,this.controls.minDistance=7}}const ay={id:"token",class:"px-5 w-full pb-[50px] pt-[100px] lg:pt-[100px] lg:pb-[150px] bg-white text-black pr-5 pl-5 lg:pr-0 lg:pl-0"},oy={class:"container lg:px-0 relative"},cy={"data-aos":"fade-up",class:"flex flex-col md:flex-col lg:flex-col xl:flex-row-reverse items-center"},ly=pe("div",{class:"w-full lg:w-full xl:w-1/2 mt-0 lg:mt-5 text-center"},[pe("div",{id:"three-coin","data-aos":"fade-up"})],-1),uy={class:"font font-light lg:w-1/2 lg:text-[30px] leading-7 lg:leading-[41px] mb-[50px]"},hy=wl('<p data-aos="fade-up"> We have deployed <b>$INU</b> on the Ethereum network to power our game ecosystem. <br><br><b>$INU</b> is a <b>deflationary utility token</b> that can be used within the <b>INUGAMES</b> ecosystem. It can be staked and rewards holders with virtual currencies of each game, can be used for governance to decide how each game is developed, access to early game releases, and more. <br><br><b>50% of the revenue generated by each game we develop will be used to buy back and burn $INU</b>, reducing the total supply and increasing the value of the token. <br><br><code>0x64669032f612Ae608671853fF8871dF0889870A9</code><ul class="mt-[20px]"><li>⚖️ 100% Fair Launch</li><li>🔒 Locked Liquidity</li><li>✅ Renounced Ownership</li><li>🎮 5/5 Tax for Marketing &amp; Game Development</li></ul></p>',1),dy={"data-aos":"fade-up",class:"flex flex-col lg:flex-row gap-[21px] mt-[50px]"},fy={target:"_blank",href:"https://app.uniswap.org/swap?chain=mainnet&inputCurrency=NATIVE&outputCurrency=0x64669032f612Ae608671853fF8871dF0889870A9",class:"bg-[#fdb04b] text-white hover:bg-black hover:text-white max-w-[260px] rounded-[8px] mt-[0px] flex text-xl leading-[16px] items-center justify-between px-[20px] py-[12px] duration-[0.3s] transition-all"},Ay={target:"_blank",href:"https://docs.inu.games/",class:"bg-[#fdb04b] text-white hover:bg-black hover:text-white max-w-[260px] rounded-[8px] mt-[0px] flex text-xl leading-[16px] items-center justify-between px-[20px] py-[12px] duration-[0.3s] transition-all"},py=Mi({__name:"Token",setup(i){return Or(()=>{new ry(document.querySelector("#three-coin"),()=>{})}),(e,t)=>(Ct(),Vt("section",ay,[pe("div",oy,[pe("div",cy,[ly,pe("div",uy,[hy,pe("div",dy,[pe("a",fy,[Rt(" 🦄  Buy Now! "),ut(js)]),pe("a",Ay,[Rt(" 📚  Read the docs "),ut(js)])])])])])]))}}),gy="/images/shiba-wif-hoodie.png",mA=i=>(Ep("data-v-0ebcda21"),i=i(),xp(),i),my={id:"community",class:"px-5 w-full pb-[50px] pt-[100px] lg:pt-[100px] lg:pb-[150px] bg-[#feb14b] text-black pr-5 pl-5 lg:pr-0 lg:pl-0"},_y={class:"container lg:px-0 relative"},by={"data-aos":"fade-up",class:"flex flex-col md:flex-col lg:flex-col xl:flex-row items-center"},Ey=mA(()=>pe("div",{class:"w-full lg:w-full xl:w-1/2 mt-0 lg:mt-5 text-center"},[pe("div",{class:"flex justify-center items-center text-center content-center pr-10"},[pe("img",{src:gy,class:"w-full animated-image"})])],-1)),xy={class:"w-full lg:w-full xl:w-1/2"},vy=mA(()=>pe("p",{class:"font font-light text-[18px] lg:text-[30px] leading-7 lg:leading-[41px] mb-[50px]"},[pe("h2",{"data-aos":"fade-up",class:"text-center font-bold leading-[87px] text-[50px] lg:text-[64px]"}," Join Us! "),Rt(" We want our members to be able to participate in the creation and improvement of our games, so we have created a community where you can share your ideas, feedback, and suggestions. "),pe("br"),pe("br"),Rt(" Use our Telegram group to chat with other members, participate in polls, contests and tournaments, and get the latest news about our games. ")],-1)),Iy={target:"_blank",href:"https://t.me/inudotgames",class:"m-auto mt-4 text-center bg-black text-white hover:bg-white hover:text-black max-w-[260px] rounded-[8px] flex text-xl leading-[16px] items-center justify-between px-[20px] py-[12px] duration-[0.3s] transition-all"},Cy=Mi({__name:"Community",setup(i){return(e,t)=>(Ct(),Vt("section",my,[pe("div",_y,[pe("div",by,[Ey,pe("div",xy,[vy,pe("a",Iy,[Rt(" 👥  Participate Now! "),ut(js)])])])])]))}}),yy=xo(Cy,[["__scopeId","data-v-0ebcda21"]]),Sy="/images/telegram.svg",My="/images/x.svg",wy="/images/dextools.svg",By="/images/email.svg",Ty="/images/github.svg",Ry={},Dy={class:"bg-black py-16"},Ly=wl('<div class="container flex justify-center"><div class="w-auto"><ul class="flex gap-x-[30px] mt-[15px]"><a target="_blank" href="https://t.me/inudotgames"><img width="35" height="35" src="'+Sy+'" alt="Telegram Icon"></a><a target="_blank" href="https://x.com/inudotgames"><img width="35" height="35" src="'+My+'" alt="Github Icon"></a><a target="_blank" href="https://www.dextools.io/app/en/token/inugames"><img width="28" height="28" src="'+wy+'" alt="Dextools Icon"></a><a target="_blank" href="mailto:dev@inu.games"><img width="34" height="34" src="'+By+'" alt="Email Icon"></a><a target="_blank" href="https://github.com/inudotgames"><img width="34" height="34" src="'+Ty+'" alt="X Icon"></a></ul></div></div><div class="text-center text-white pt-5"> INUGAMES © 2024 </div>',2),Py=[Ly];function Fy(i,e){return Ct(),Vt("footer",Dy,Py)}const Uy=xo(Ry,[["render",Fy]]),Ny="/images/game-process.png",Qy="/images/game-shiba-island.jpg",Oy="/images/game-meme-wars.png",ky={id:"games",class:"px-5 w-full pt-[30px] lg:pt-[100px] pb-[0px] lg:pb-[70px] bg-[#000000] pb-[30px]"},Gy={class:"container lg:px-0"},Hy=pe("h1",{class:"text-center font-semibold leading-[50px] lg:leading-[87px] text-3xl lg:text-[64px] text-white","data-aos":"fade-up"}," Our Games ",-1),zy=pe("div",null,[pe("p",{class:"text-center text-white font-light text-[18px] lg:text-[30px] leading-7 lg:leading-[41px] mt-[20px]","data-aos":"fade-up"},[pe("img",{class:"m-auto",src:Ny}),Rt(" Each game is crafted with love and care by our team of developers and designers. "),pe("br"),Rt(" We start "),pe("b",null,"simple"),Rt(" and build upon the "),pe("b",null,"feedback of our community"),Rt(" to create the "),pe("b",null,"best gaming"),Rt(" experience. ")])],-1),Vy={class:"flex flex-col lg:flex-row gap-[20px] mt-[20px] lg:mt-[50px] text-center"},Wy={class:"w-full lg:w-1/2"},qy={class:"font-light text-[18px] lg:text-[30px] leading-7 lg:leading-[41px] mb-[50px]","data-aos":"fade-up"},jy=pe("h2",{class:"font-bold text-4xl"},"Shiba Island",-1),Ky=pe("br",null,null,-1),Yy=pe("img",{class:"m-auto max-w-[350px]",src:Qy},null,-1),Xy=pe("br",null,null,-1),Jy=pe("p",{class:"font-light max-w-[350px] text-[18px] lg:text-[24px] leading-7 lg:leading-[41px] m-auto","data-aos":"fade-up"}," Build your island, fight monsters, and compete against others in this Treasure Royale game! ",-1),$y=pe("br",null,null,-1),Zy={target:"_blank",href:"https://shibaisland.io/",class:"m-auto mt-4 text-center bg-white text-black hover:bg-[#fdb04b] hover:text-black max-w-[260px] rounded-[8px] flex text-xl leading-[16px] items-center justify-between px-[20px] py-[12px] duration-[0.3s] transition-all"},eS={class:"w-full lg:w-1/2"},tS={class:"font-light text-[18px] lg:text-[30px] leading-7 lg:leading-[41px] mb-[50px]","data-aos":"fade-up"},nS=pe("h2",{class:"font-bold text-4xl"},"Meme Wars",-1),iS=pe("br",null,null,-1),sS=pe("img",{class:"m-auto max-w-[350px]",src:Oy},null,-1),rS=pe("br",null,null,-1),aS=pe("p",{class:"font-light max-w-[350px] text-[18px] lg:text-[24px] leading-7 lg:leading-[41px] m-auto","data-aos":"fade-up"}," Fight to be the last one standing in this battle royale game using your favorite meme characters! ",-1),oS=pe("br",null,null,-1),cS={class:"m-auto mt-4 text-center bg-white text-black hover:bg-[#aaa] cursor-pointer hover:text-black max-w-[260px] rounded-[8px] flex text-xl leading-[16px] items-center justify-between px-[20px] py-[12px] duration-[0.3s] transition-all"},lS=Mi({__name:"Games",setup(i){return(e,t)=>(Ct(),Vt("section",ky,[pe("div",Gy,[Hy,zy,pe("div",Vy,[pe("div",Wy,[pe("div",qy,[jy,Ky,Yy,Xy,Jy,$y,pe("a",Zy,[Rt(" 🕹️  Play Now! "),ut(js)])])]),pe("div",eS,[pe("div",tS,[nS,iS,sS,rS,aS,oS,pe("a",cS,[Rt(" 🕓  Coming Soon "),ut(js,{class:"invisible"})])])])])])]))}}),uS="/images/inugames-icon.svg",hS={},dS={class:"spinner"},fS=pe("div",null,[pe("img",{class:"inu-icon",src:uS,alt:"Inu Icon",width:"200"})],-1),AS=[fS];function pS(i,e){return Ct(),Vt("div",dS,AS)}const gS=xo(hS,[["render",pS]]),mS={key:1},_S=Mi({__name:"App",setup(i){const e=bt(!0),t=async()=>{await new Promise(n=>{setTimeout(n,1500)}),e.value=!1};return Or(()=>{lm.init(),t()}),(n,s)=>(Ct(),Vt("div",null,[e.value?(Ct(),Ml(gS,{key:0})):vr("",!0),e.value?vr("",!0):(Ct(),Vt("div",mS,[ut(bm),ut(zC),ut(iy),ut(lS),ut(py),ut(yy),ut(Uy)]))]))}});qg(_S).use(rm).mount("#app");
